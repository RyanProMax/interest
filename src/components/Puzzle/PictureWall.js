...
export default function PictureWall({ onChange }) {
  ...
  return (
    <>
      <Upload customRequest={customRequest} listType='picture-card' fileList={fileList} onPreview={handlePreview} onChange={handleChange} multiple>
        {/* {fileList.length >= 8 ? null : uploadButton} */}
        {uploadButton}
      </Upload>
      <Modal visible={!!preview} title={previewTitle} footer={null} onCancel={handleCancel}>
